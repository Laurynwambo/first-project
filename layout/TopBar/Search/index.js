                ...
                <div className="row">
                  <div className="col-lg-4">
                    <div className={style.resultContent}>
                      ...
                      <div className={style.result}>
                        <div className={style.resultText}> Toyota RAV4 </div>
                    ...
                    <div className={style.resultContent}>
                      ...
                      <div className={style.result}>
                        <div className={style.resultText}>Mazda cx5</div>
                        <div className={style.resultSource}>In some partition</div>
                      </div>
                    </div>
                    <div className={style.resultContent}>
                      ...
                      <div className={style.result}>
                        <div className={style.resultText}>Toyota Mazda demio</div>
                        <div className={style.resultSource}>In some partition</div>
                      </div>
                    </div>
                    <div className={style.resultContent}>
                      ...
                      <div className={style.result}>
                        <div className={style.resultText}>Toyota Allion</div>
                        <div className={style.resultSource}>In some partition</div>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4">
                    <div className={style.resultContent}>
                      ...
                      <div className={style.result}>
                        <div className={style.resultText}>White</div>
                        <div className={style.resultSource}>In some partition</div>
                      </div>
                    </div>
                    <div className={style.resultContent}>
                      ...
                      <div className={style.result}>
                        <div className={style.resultText}>Black</div>
                        <div className={style.resultSource}>In some partition</div>
                      </div>
                    </div>
                    <div className={style.resultContent}>
                      ...
                      <div className={style.result}>
                        <div className={style.resultText}>Red</div>
                        <div className={style.resultSource}>In some partition</div>
                      </div>
                    </div>
                  </div>
